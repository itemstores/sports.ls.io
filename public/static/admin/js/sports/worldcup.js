        ...
        index: function () {
            ea.table.render({
                ...
                cols: [[
                    ...
                    { field: 'home_let_score', minWidth: 150, title: '主队让分', },
                    { field: 'home_let_odds', minWidth: 150, title: '主队让分赔率', },
                    { field: 'home_size_score', minWidth: 150, title: '主队大小', },
                    { field: 'home_size_odds', minWidth: 150, title: '主队大小赔率', },
                    { field: 'home_goals', minWidth: 150, title: '主队赛果', },
                    { field: 'away_team', minWidth: 120, title: '客队', },
                    { field: 'away_logo', minWidth: 120, title: '客队logo', search: false, templet: ea.table.image },
                    { field: 'away_let_score', minWidth: 150, title: '客队让分', },
                    { field: 'away_let_odds', minWidth: 150, title: '客队让分赔率', },
                    { field: 'away_size_score', minWidth: 150, title: '客队大小', },
                    { field: 'away_size_odds', minWidth: 150, title: '客队大小赔率', },
                    { field: 'away_goals', minWidth: 150, title: '客队赛果', },
